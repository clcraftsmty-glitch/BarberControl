<div class="mx-auto max-w-4xl">
    <div class="mb-6"><a href="{{ route('services.show', $form->service) }}" wire:navigate class="text-sm font-semibold text-brand-600">← Volver al detalle</a><h1 class="mt-2 text-2xl font-extrabold text-slate-950">Editar servicio</h1><p class="mt-1 text-sm text-slate-500">Actualiza {{ $form->service->name }}.</p></div>
