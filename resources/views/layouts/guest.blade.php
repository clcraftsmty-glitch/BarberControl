        ...
        <main class="grid min-h-screen lg:grid-cols-2">
            <section class="relative hidden overflow-hidden bg-slate-950 p-12 text-white lg:flex lg:flex-col lg:justify-between">
                ...
                <a href="/" class="relative flex items-center gap-3">
                    <span class="flex h-11 w-11 items-center justify-center rounded-xl bg-brand-600"><x-application-logo class="h-7 w-7 text-white" /></span>
                    <span class="text-xl font-bold">BarberControl</span>
                </a>
                ...
                <p class="relative text-sm text-slate-500">© {{ date('Y') }} BarberControl</p>
            </section>
